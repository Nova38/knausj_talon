from talon import ctrl, Context, Module, actions, storage, imgui, ui, canvas
...
mod.list(
    "saved_spots",
    desc="List of spots that have been saved with the 'user.save_spot' command"
)
...
class SpotClass:
    def save_spot(spot_key: str):
        ...
        ctx.lists["user.saved_spots"] = spot_dictionary.keys()
